...
public class HistoricoDeJogo {
	...
	private int pontuacao; //informa quantos pontos o jogador recebe, de acordo com o tipo de vitória 
	...
	/**
	 * Informa a pontuação do tipo de vitória
	 * 
	 * @param pontuacao os pontos da vitória
	 */
	...
	/**
	 * 
	 * @return a pontuação da vitória na partida
	 */
